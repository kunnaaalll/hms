...
export function AdminHeader() {
  // const { setTheme, theme } = useTheme(); // For theme toggle

  return (
    <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b bg-background px-4 md:px-6 shadow-sm">
      <SidebarTrigger className="md:hidden" /> {/* Hidden on md and up, shown on mobile to toggle sidebar */}
      <div className="flex-1">
        <h1 className="text-lg font-semibold">Admin Dashboard</h1>
      </div>
      <div className="flex items-center gap-4">
        {/* Theme toggle example - requires next-themes setup
        <Button
          variant="ghost"
          size="icon"
